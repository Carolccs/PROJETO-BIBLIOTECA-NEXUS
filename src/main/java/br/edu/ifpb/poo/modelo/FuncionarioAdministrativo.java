...
public class FuncionarioAdministrativo extends Usuario {
    ...
    public static final int PRAZO_DIAS = 10;
    public static final double VALOR_MULTA_DIARIA = 1.50;

    public FuncionarioAdministrativo(int id, String nome, String email) {
        super(id, nome, email);
    }
